...
def instructions():
    ...
    print('''
To use this program simply enter an integer between 1 and 200. The program will show the factors of your chose integer.

It will also tell you if your chosen number...
- is a prime number (ie: it has 2 factors)
- is a perfect square
...
while True:
    ...
    # ask user for number to be factorized
